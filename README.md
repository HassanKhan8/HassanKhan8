...
## 🧑‍💻 About Me
Final-semester **Computer Science** student specializing in:

- Machine Learning & Deep Learning  
- Computer Vision (YOLOv8, Segmentation, OpenCV)  
- NLP Pipelines & Text Classification  
- Predictive Modeling & Decision Systems  

I focus on building **practical, scalable, and impactful** AI solutions for real-world applications.
...
- **Underwater Crack Detection** – High-precision segmentation using YOLOv8 for structural safety analysis.  
...
- Build AI-driven products for health, safety, and automation  
- Work in deep learning research and applied machine learning  
- Contribute to impactful, production-grade ML systems  
